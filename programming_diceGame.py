...
# 1. uses 6-sided, 10-sided, and 10-sided dice
# 2. uses a cup to hold the dice
# 3. lets the user shake the cup with the desired diced number and gets the sum of the dice
...
# Placing dies in a cup and rolling them
#####################################################################################


class Cup:
    """Takes in a set number of dies and places them in a cup. It rolls the cup and obtains the sum of all the rolled dies inside the cup."""
    ...
    def getSum(self): 
        """ Returns the sum of the dies rolled."""
